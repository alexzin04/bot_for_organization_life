...
bank_count=InlineKeyboardButton(text='Деньги на счетах',callback_data='bank_count')
finance_data_keyboard.insert(bank_count)
history_consumption=InlineKeyboardButton(text='История расходов',callback_data='history_consumption')
finance_data_keyboard.insert(history_consumption)
change_account_money=InlineKeyboardButton(text='Изменение суммы на счетах',callback_data='change_account_money')
finance_data_keyboard.insert(change_account_money)
add_new_category=InlineKeyboardButton(text='Добавление новой категории',callback_data='add_new_category')
finance_data_keyboard.insert(add_new_category)
...
finance_add_new_category_yes_no_keuboard=InlineKeyboardMarkup(row_width=2)
yes=InlineKeyboardButton(text='Да',callback_data='add_new_category_yes')
no=InlineKeyboardButton(text='Нет',callback_data='finance_data')
finance_add_new_category_yes_no_keuboard.add(yes)
finance_add_new_category_yes_no_keuboard.add(no)
